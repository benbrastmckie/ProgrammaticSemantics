...
I demonstrate in Brast-McKie (\href{https://github.com/benbrastmckie/ModelChecker/blob/master/Counterfactuals.pdf}{forthcoming}) how to define \citepos{Fine2012a,Fine2012b} imposition relation in terms of the primitives that \cite{Fine2017d,Fine2017,Fine2017a} includes in a modalized state space to provide a logic for counterfactual conditionals which is at least strong.
